...
let s:airline_c_normal   = [ '#9cffd3' , '#202020' , 17  , 252 ]
...
let s:airline_a_inactive = [ '#4e4e4e' , '#1c1c1c' , 17, 252 , '' ]
let s:airline_b_inactive = [ '#4e4e4e' , '#262626' , 17, 252 , '' ]
let s:airline_c_inactive = [ '#4e4e4e' , '#303030' , 17, 252 , '' ]
